...
// ReSharper restore StaticFieldInGenericType
	    ...
	    public void Execute(authorizenet.Environment environment) {
            ...
            if (null != httpApiResponse)
		    {
                ...
                else if (httpApiResponse.GetType() == typeof(authorizenet.apicore.controller.bases.ErrorResponse))
                {
	    ...
	    private void Validate() {
		    ...
		    //validate not nulls
            if (null == request.merchantAuthentication) throw new ArgumentException("MerchantAuthentication cannot be null");
