...
namespace AuthorizeNet {
    public interface IGatewayRequest {
        ...
        IGatewayRequest AddCustomer(string ID, string first, string last, string address, string city, string state, string zip);
        ...
        IGatewayRequest AddShipping(string ID, string first, string last, string address, string city, string state, string zip);
