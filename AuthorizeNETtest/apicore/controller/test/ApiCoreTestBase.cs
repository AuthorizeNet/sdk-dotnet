namespace authorizenet.apicore.helper.test
{
    using System;
...
#pragma warning disable 649
    ...
    public abstract class ApiCoreTestBase {
        ...
        protected static TS ExecuteTestRequestWithSuccess<TQ, TS, TT>(TQ request, authorizenet.Environment execEnvironment)
        ...
        protected static TS ExecuteTestRequestWithFailure<TQ, TS, TT>(TQ request, authorizenet.Environment execEnvironment)
            where TQ : ANetApiRequest
            where TS : ANetApiResponse
            where TT : ApiOperationBase<TQ, TS> 
        {
	    ...
	    private static TS ExecuteTestRequest<TQ, TS, TT>(bool successExpected, TQ request, authorizenet.Environment execEnvironment) 
            where TQ : ANetApiRequest
            where TS : ANetApiResponse
            where TT : ApiOperationBase<TQ, TS> 
        {
