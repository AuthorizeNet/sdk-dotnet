...
namespace AuthorizeNet.Api.Controllers.SampleTest
{
	...
	public class CreateECheckTransactionSampleTest : ApiCoreTestBase
	{
		...
		public void CreateCreditRequestForSettledECheckTransaction()
		{
			...
			txnCardNo = ((creditCardMaskedType)(gtdResp.transaction.payment.Item)).cardNumber;
		...
		public void CreateTransactionWithECheckCapturePriorAuth()
		{
			...
			{
				accountNumber = ((bankAccountMaskedType)(getDetailsResp.transaction.payment.Item)).accountNumber.TrimStart(new char[] { 'X' }),
				routingNumber = "XXXX",
				nameOnAccount = ((bankAccountMaskedType)(getDetailsResp.transaction.payment.Item)).nameOnAccount,
				bankName = ((bankAccountMaskedType)(getDetailsResp.transaction.payment.Item)).bankName,
				echeckType = ((bankAccountMaskedType)(getDetailsResp.transaction.payment.Item)).echeckType,
			};
