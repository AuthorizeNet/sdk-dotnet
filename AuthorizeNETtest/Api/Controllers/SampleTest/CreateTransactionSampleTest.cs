...
namespace AuthorizeNet.Api.Controllers.SampleTest
{
	...
	public class CreateTransactionSampleTest : ApiCoreTestBase
	{
		...
		public void SampleCodeCreateTransaction()
		{
			...
			Assert.IsTrue(long.TryParse(createResponse.transactionResponse.transId, out var transId));
			if (0 == transId)
			{
		...
		public void SampleCodeCreateTransactionUsingProfile()
		{
			...
			Assert.IsTrue(CreateProfile(out var customerProfileId, out var paymentProfileId));
		...
		private bool CreateProfile(out String customerProfileId, out String paymentProfileId)
		{
		...
		public void SampleCodeCreateTransactionWithPayPal()
		{
			...
			//Common code to set for all requests
			ApiOperationBase<ANetApiRequest, ANetApiResponse>.MerchantAuthentication = CustomMerchantAuthenticationType;
			ApiOperationBase<ANetApiRequest, ANetApiResponse>.RunEnvironment = Environment.SANDBOX; //TestEnvironment;
